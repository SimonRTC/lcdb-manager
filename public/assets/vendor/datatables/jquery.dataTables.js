...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Afficher _START_ à _END_ de _TOTAL_ entrées",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Affiche 0 à 0 de 0 entrées",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Aficher _MENU_ entrées",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "search": "Appliquer le filtre _INPUT_ à la table"
			 *        }
			 *      } );
			 *    } );
			 */
